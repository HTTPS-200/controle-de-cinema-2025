...
public abstract class TestFixture
{
    ...
    private static DotNet.Testcontainers.Networks.INetwork? network;
    ...
    private static async Task InicializarAplicacaoAsync()
    {
        ...
        appContainer = new ContainerBuilder()
            ...
            //.WithEnvironment("NEWRELIC_LICENSE_KEY", configuracao?["NEWRELIC_LICENSE_KEY"]) // aguardando chave válida
            .WithWaitStrategy(Wait.ForUnixContainer()
